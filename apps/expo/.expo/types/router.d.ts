...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(authenticated)/` | `/(authenticated)` | `/(authenticated)/map` | `/map` | `/(authenticated)/profile` | `/profile` | `/(authenticated)/snus` | `/snus` | `/(authenticated)/social` | `/social` | `/(non-authenticated)/` | `/(non-authenticated)` | `/(non-authenticated)/signin` | `/signin`;
  // prettier-ignore
